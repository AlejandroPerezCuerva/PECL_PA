...
public class MainServ extends javax.swing.JFrame {
    ...
    public MainServ() throws IOException {
        ...
        //Insertamos todos los JTextField necesarios de SalaVacunacion y el número máximo de aforo
    ...
    private void initComponents() {
        ...
        puesto1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                puesto1ActionPerformed(evt);
            }
        });
    ...
    private void puesto1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_puesto1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_puesto1ActionPerformed

    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        try {
            // TODO add your handling code here:
            //Evento que se utiliza para cuando se cierra la ventana
            //Desde aquí se cierra el fichero
            fichero.close();
